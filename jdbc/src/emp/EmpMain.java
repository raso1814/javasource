	...
	public static void main(String[] args) {
		...
		while (run) {
			...
			case 4:
				...
				System.out.println(updateFlag ? "업데이트성공" : "업데이트실패");
				System.out.println();
			...
			case 6:
				...
				System.out.println(dao.insertEmp(newDto) ? "입력성공" : "입력실패");
			...
			case 7:
				...
				System.out.println(dao.deleteEmp(empno) ? "삭제성공" : "삭제실패");
				System.out.println();
